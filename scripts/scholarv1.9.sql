...
-- Dumping data for table 123456789.profile: ~11 rows (approximately)
DELETE FROM `profile`;
...
INSERT INTO `profile` (`id`, `first_name`, `middle_name`, `last_name`, `prefix`, `date_of_birth`, `image`, `parent_type`, `parent_id`, `status`, `date_created`, `author_id`) VALUES
	...
	(13, 'Mopetp', NULL, 'Pilota', 'MR', '2018-05-10', NULL, NULL, NULL, 'ACTIVE', '2018-05-06 13:03:06', 1),
	(14, 'mover', NULL, 'moaotea', 'MR', '2018-03-04', NULL, NULL, NULL, 'ACTIVE', '2018-05-17 23:07:38', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Manage Roles';
