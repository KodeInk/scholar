...
DROP DATABASE IF EXISTS `123456789`;
...
DROP TABLE IF EXISTS `grading_details`;
...
DROP TABLE IF EXISTS `library_stock_inventory`;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='Person Details';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Streams';
...
DROP TABLE IF EXISTS `student_exam_registration`;
...
DROP TABLE IF EXISTS `student_term_registration`;
CREATE TABLE IF NOT EXISTS `student_term_registration` (
  ...
  `author_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `admission_id_term_id_class_id_stream_id` (`admission_id`,`term_id`,`class_id`,`stream_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Student Term Registration';
...
DROP TABLE IF EXISTS `study_year_curriculum`;
...
DROP TABLE IF EXISTS `subject_grading`;
...
DROP TABLE IF EXISTS `teaching_timetable`;
