...
-- Dumping data for table 123456789.users: ~1 rows (approximately)
DELETE FROM `users`;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='User Role';

-- Dumping data for table 123456789.user_role: ~1 rows (approximately)
