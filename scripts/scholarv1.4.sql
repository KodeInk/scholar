...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='System Users';

-- Dumping data for table 123456789.users: ~7 rows (approximately)
DELETE FROM `users`;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='User Role';

-- Dumping data for table 123456789.user_role: ~2 rows (approximately)
