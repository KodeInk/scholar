...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Manage Department';
...
INSERT INTO `departments` (`id`, `name`, `code`, `description`, `isSystem`, `status`, `parent_id`, `date_created`, `author_id`) VALUES
	(1, 'Teaching Department', '0', 'Mathmatic Department', b'1', 'ACTIVE', NULL, '2018-03-16 14:53:13', 1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Staff';
