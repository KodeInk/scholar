...
public class LibraryTransactionResponse {
    ...
    public LibraryTransactionResponse() {
    }

    public LibraryTransactionResponse(Integer id) {
        this.id = id;
    }
    ...
    public int hashCode() {
        ...
        hash = 47 * hash + Objects.hashCode(this.inventory_id);
        hash = 47 * hash + Objects.hashCode(this.borrower_id);
        hash = 47 * hash + Objects.hashCode(this.borrower_type);
        hash = 47 * hash + Objects.hashCode(this.expected_return_date);
        hash = 47 * hash + Objects.hashCode(this.actual_return_date);
        hash = 47 * hash + Objects.hashCode(this.transaction_type);
        ...
        hash = 47 * hash + Objects.hashCode(this.parent_transaction_id);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final LibraryTransactionResponse other = (LibraryTransactionResponse) obj;
    ...
    public String toString() {
        return "LibraryTransactionResponse{"
                + "id=" + id
