...
public class StudentRegistrationResponse {
    ...
    public StudentRegistrationResponse(Integer id) {
        this.id = id;
    }
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + Objects.hashCode(this.admission_id);
        hash = 29 * hash + Objects.hashCode(this.term_id);
        hash = 29 * hash + Objects.hashCode(this.stream_id);
    ...
    public boolean equals(Object obj) {
        ...
        final StudentRegistrationResponse other = (StudentRegistrationResponse) obj;
