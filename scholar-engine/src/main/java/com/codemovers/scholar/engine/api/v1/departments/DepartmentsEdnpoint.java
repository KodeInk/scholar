 ...
 */
public class DepartmentsEdnpoint extends AbstractEndpoint<_Department, DepartmentResponse> {

    private static final Logger LOG = Logger.getLogger(DepartmentsEdnpoint.class.getName());
    @Context
    private ContainerRequestContext context;
    private DepartmentsService service = null;
    private AuthenticationResponse authentication = null;

    public DepartmentsEdnpoint() {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Override
    public DepartmentResponse update(_Department entity,
            @HeaderParam("authentication") String authentication,
            @Context HttpServletRequest httpRequest) throws Exception {
        validate(tenantdata, authentication);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Override
    public DepartmentResponse archive(Integer id,
            @HeaderParam("authentication") String authentication,
            @Context HttpServletRequest httpRequest) throws Exception {
        validate(tenantdata, authentication);
